            ...
            <section id="content" class="container"  style="margin: 0 auto;">
                ...
                <div class="block-area" id="media-object">
                    ...
                    <security:guest>
                        ...
                        <button type="button" class="btn btn-alt m-r-5" onclick="javascript:location.href='/login_view?href=/visitor_article/article_detail_view?id=${article.id}&currentPage=${pager.currentPage}'">登录</button>
                    </security:guest>
                    ...
                    <page:page  value="${pager}"  url="/visitor_article/article_detail_view?id=${article.id}"></page:page>
                    ...
                    $.ajax({
                        ...
                        success: function (data){
                            ...
                            if(2 == result.length){
                                if(1 == result[0]){
                                    //alert("成功");
                                    location.href = "/visitor_article/article_detail_view" +
                                            "?id=" + articleId +"&focusid=" + result[1] + "&currentPage=" + $("#currentPage").val();
                                }else {
                                    alert("失败");
                                }
                            }else {
                    ...
                    success: function (data){
                        ...
                        if(2 == result.length){
                            if(1 == result[0]){
                                //alert("成功");
                                location.href = "/visitor_article/article_detail_view" +
                                        "?id=" + articleId + "&focusid=-1&currentPage=" + $("#currentPage").val();
                            }else {
                                alert("失败");
                            }
                        }else {
                    ...
                    success: function (data){
                        ...
                        if(2 == result.length){
                            if(1 == result[0]){
                                //alert("成功");
                                location.href = "/visitor_article/article_detail_view" +
                                        "?id=" + articleId + "&focusid=" + pMsgId + "&currentPage=" + $("#currentPage").val();
                            }else {
                                alert(result[1]);
                            }
                        }else {
