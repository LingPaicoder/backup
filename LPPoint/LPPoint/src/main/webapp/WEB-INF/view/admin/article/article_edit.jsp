...
<!--[if IE 9 ]><html class="ie9"><![endif]-->
    ...
    <body id="skin-tectile">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="tile">
                                ...
                                <form role="form" class="p-15">
                                    ...
                                    <div class="form-group m-b-15">
                                        <label>摘要</label>
                                        <input type="text" class="form-control input-sm" name="summary" id="summary" value="${article.summary}">
                                    </div>

                                    <div class="form-group m-b-15">
                                        <label>类别</label>
                                        <input type="text" class="form-control input-sm" name="types" id="types" value="${article.types}">
                                    </div>
                            ...
                            <button type="button" class="btn btn-lg btn-alt" onclick="editArticle()">提交</button>
                            &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <script type="text/javascript">
            ...
            $(function () {
                $("#coverImg").html('${article.coverImgStr}');
                $(".note-editable").html('${article.articleContentStr}');
            })
            ...
            function editArticle(){
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    async: "false",
                    url: "/admin_article/article_edit",
                    data: {
                        id : articleId,
                        coverImg : coverImg,
                        title : title,
